...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+880) 1970 806028",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "tanvirhasan00@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">Enhance your business with me.</p>
              {/* input */}
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="est">Web Application</SelectItem>
                    <SelectItem value="cst">Mobile Application</SelectItem>
